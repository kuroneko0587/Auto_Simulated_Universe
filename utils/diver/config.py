...
class Config:
    def __init__(self):
        ...
        self.text = "info.yml"
        self.skill_char = ['符玄', '阮梅', '黄泉', '流萤']
        self.long_range_list = ['丹恒饮月','克拉拉','希露瓦','青雀','波提欧','托帕账账','彦卿','符玄','砂金','三月七','娜塔莎','阮梅','知更鸟','布洛妮娅','艾丝妲','驭空','黑天鹅','瓦尔特杨','佩拉']
        self.all_list = ['飞霄','灵砂','流萤','黄泉','波提欧','真理医生','丹恒饮月','瓦尔特杨','克拉拉','银枝','刃','希儿','景元','镜流','卡芙卡','托帕账账','黑天鹅','翡翠','云璃','砂金','椒丘','彦卿','姬子','杰帕德','藿藿','白露','阿兰','素裳','加拉赫','知更鸟','阮梅','布洛妮娅','花火','符玄','银狼','罗刹','朝仓','寒鸦','卢卡','桂乃芬','虎克','艾丝妲','米沙','佩拉','黑塔','三月七','停云','桑博','雪衣','青雀','玲可','驭空','娜塔莎','希露瓦']
